...
public class TercerTrimestre extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button.OnClickListener fileExplorerOnClickListener = new Button.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(TercerTrimestre.this,
						VisorArchivo.class);
		...
		Button.OnClickListener enviarDatosOnClickListener = new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				task.applicationContext = TercerTrimestre.this;
	...
	public class CallWebServiceTask extends AsyncTask<String, Void, Integer> {
		...
		protected Integer doInBackground(String... params) {
			...
			int resultado = 0;
			enviarMedidas();
			resultado = sendFile(username, cedulaPaciente);
			return resultado;
		}
